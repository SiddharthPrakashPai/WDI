...
public class DBPedia_Zenodo_Book implements Matchable {
	...
	* Zenodo
	...
	public DBPedia_Zenodo_Book(String identifier,  String provenance) {
		id = identifier;
	...
	public boolean equals(Object obj) {
		if(obj instanceof DBPedia_Zenodo_Book){
			return this.getIdentifier().equals(((DBPedia_Zenodo_Book) obj).getIdentifier());
		}else
			return false;
	}	
