 ...
 *
 */
public class MovieCSVFormatter extends CSVDataSetFormatter<DBPedia_Zenodo_Book, Attribute> {
	 ...
	 */
	@Override
	public String[] format(DBPedia_Zenodo_Book record, DataSet<DBPedia_Zenodo_Book, Attribute> dataset, List<Attribute> orderedHeader) {
		return new String[] {
