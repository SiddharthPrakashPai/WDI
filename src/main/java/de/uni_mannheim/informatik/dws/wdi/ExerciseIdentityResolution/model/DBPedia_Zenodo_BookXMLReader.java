...
public class DBPedia_Zenodo_BookXMLReader extends XMLMatchableReader<DBPedia_Zenodo_Book, Attribute>  {

	/* (non-Javadoc)
	 * @see de.uni_mannheim.informatik.wdi.model.io.XMLMatchableReader#initialiseDataset(de.uni_mannheim.informatik.wdi.model.DataSet)
	 */
	@Override
	protected void initialiseDataset(DataSet<DBPedia_Zenodo_Book, Attribute> dataset) {
