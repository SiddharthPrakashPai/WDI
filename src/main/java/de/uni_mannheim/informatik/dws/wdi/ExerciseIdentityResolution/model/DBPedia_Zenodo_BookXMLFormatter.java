...
public class DBPedia_Zenodo_BookXMLFormatter extends XMLFormatter<DBPedia_Zenodo_Book> {

	Zenodo_BookXMLFormatter actorFormatter = new Zenodo_BookXMLFormatter();
	...
	@Override
	public Element createElementFromRecord(DBPedia_Zenodo_Book record, Document doc) {
